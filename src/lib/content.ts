...
const FALLBACK_EVENTS: EventItem[] = [
  { id: 'o1', slug: 'o1', title: 'MLK Day Art Competition', date: 'Submissions due January 31', location: '', description: 'Ongoing art competition honoring Dr. Martin Luther King Jr. Create a piece that reflects service, equity, and hope.', category: 'key', coverImage: '/images/events/MLK.png', images: [], href: null, sortOrder: 0 },
  { id: 'friday-cards', slug: 'friday-cards', title: 'Friday Card Sessions', date: 'Ongoing — Every Friday', location: 'Rockville Memorial Library', description: 'Every Friday, youth and community members gather at the library to hand-illustrate get-well cards for hospital patients — spreading joy through art.', category: 'key', coverImage: '/images/events/friday-cards/friday-3.png', images: [], href: '/events/friday-sessions', sortOrder: 1 },
